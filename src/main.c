...
static const struct bt_data ad[] = {
	...
	//BT_DATA_BYTES(BT_DATA_UUID128_ALL, BT_UUID_LED_SERVICE_VAL),		/* A 128 Service UUID for the our custom service follows */
        ...
        //BT_DATA_BYTES(BT_DATA_UUID128_ALL, BT_UUID_COUNTER_SERVICE_VAL),		/* A 128 Service UUID for the our custom service follows */
        //BT_DATA_BYTES(BT_DATA_UUID128_ALL, BT_UUID_CODE_SERVICE_VAL)		/* A 128 Service UUID for the our custom service follows */
};
